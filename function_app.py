...
# def GetAvengers(req: func.HttpRequest) -> func.HttpResponse:
#     logging.info('Python HTTP trigger function processed a request.')

#     # code name is part of url path or optional query parameter
#     code_name = req.route_params.get('codename', None)

#     if code_name:
#         real_name = avengers.get(code_name, None)
#         if not real_name:
#             return func.HttpResponse(
#                 f"Avenger with code name '{code_name}' not found.",
#                 status_code=404
#             )
#         return func.HttpResponse(json.dumps({"code_name": code_name, "real_name": real_name}), status_code=200, mimetype="application/json")
#     else:
#         # if no code name is provided, return all avengers
#         return func.HttpResponse(json.dumps(avengers), status_code=200, mimetype="application/json")
